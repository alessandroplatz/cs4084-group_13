...
public class PopQuizTestView extends AppCompatActivity {
    ...
    private ArrayList<Flashcard> randflashcards;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_quiz_test_view);
        ...
        for(int i =0;i<10;i++) {
            randflashcards.add(flashcards.get(i));
        }
        db.close();
    ...
    public void testStart() {
        ...
        currentFC = randflashcards.remove(0);
        ...
        //this is an extra addition as without the other confirm screen if the user goes too fast it can cause buttons to become locked
        ...
        reviewansbut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(PopQuizTestView.this,ReviewAnswers.class);
                Bundle b = new Bundle();
    ...
    public void onSubmit() {
        if (answer.getText().toString().isEmpty()) {
            Toast.makeText(PopQuizTestView.this,"Please Attempt the Question!",Toast.LENGTH_SHORT).show();
        } else {
            subBut.setEnabled(false);
    ...
    public void wrongAnswer() {
        ...
        if (finishTest) {
            ...
            nextQuestion();
            transition(confirmBox, answerbox, new Runnable() {
                @Override
                public void run() {
                    back.setText(FCBack);
                    SOBut.setEnabled(true);
